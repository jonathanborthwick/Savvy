...
<head>
	...
	<?php wp_head(); ?>
<script src="//www.apex.live/scripts/invitation.ashx?company=armstrong"async></script>
...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-NBLGDV"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-NBLGDV');</script>
					...
					<div class="header_inner_left">
						...
						<div class="logo_wrapper">
                            ...
                            <div class="header_center">
                            	<?php dynamic_sidebar('c_header_center'); ?>
                            </div>
                            <div class="header_right">
                            	<?php dynamic_sidebar('c_header_right'); ?>
                            </div>
