...
function registerSides(){
	register_sidebar( array(
        'name' =>  'Custom Header Center',
        'id' => 'c_header_center',
        'description' =>  'Widget area in center of header.',
        'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
        ...
        'id' => 'c_header_right',
        'description' =>  'Widget area on right side of header.',
        'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<h2 class="widgettitle">',
		'after_title'   => '</h2>',
...
add_action('widgets_init', 'registerSides');
...
function display_action_box ( $atts ){
	return '<div class="service-info-button">Get your free estimate today!<br/>Call <a href="tel:877-777-1234" title="Click to Call on Smart Phones"><b>877-777-1234</b></a>, or <a href="http://www.armstrong1234.com/contact/"><b>contact us online</b></a>.</div>';
}
add_shortcode( 'action_box', 'display_action_box' );
